...
const Contact = () => {
    ...
    const formSubmit = (e) => {
        //e.preventDefault(); 
        alert(`My name is ${data.fullname}, my PhoneNo. is ${data.phone} and my email is ${data.email} I just want to say that ${data.msg}!!`);
    }
                ...
                <div className="row">
                    <div className="col-md-6 col-10 mx-auto ">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="tel" className="form-control" id="exampleFormControlInput1" name="phone" value={data.phone} onChange={InputEvent} placeholder="+923012345678" />
                        </div>
                        <div className="mb-3">
